...
public class MainActivityInstrumentedTest {
    ...
    public void sortTaskByProject() {
        ...
        onData(allOf(withId(R.id.project_spinner), withSpinnerText("Projet Tartampion"))).inRoot(isPlatformPopup()).perform(click());
       /* ViewInteraction customTextView = onView(allOf(withId(R.id.project_spinner), withSpinnerText("Projet Tartampion"))).inRoot(isPlatformPopup());
        customTextView.perform(click());*/
      /*   = onView(
                allOf(withId(R.id.project_spinner), withText(), isDisplayed()));
        customTextView.perform(click());
*/
        ...
        onView(withId(R.id.txt_task_name)).perform(replaceText("zzz Tâche example"));
        onView(withId(R.id.project_spinner)).perform(click());
        //onData(allOf(is(instanceOf(String.class)), is("Projet Lucidia"))).perform(click());

        onView(withId(R.id.fab_add_task)).perform(click());
        onView(withId(R.id.txt_task_name)).perform(replaceText("hhh Tâche example"));
        onView(withId(R.id.project_spinner)).perform(click());
        //onData(allOf(is(instanceOf(String.class)), is("Projet Circus"))).perform(click());
