...
public class DaoTest {
    ...
    private static final Project PROJECT_1 = new Project(4L, "PROJECT 1", 0xFFEADAD1);
    private static final Task TASK_1_PROJECT_1 = new Task(4L, "task 1", new Date().getTime());
